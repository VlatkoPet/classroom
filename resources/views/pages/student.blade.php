    ...
    <div class="container">
        <div class="row ">
            <div class="col-12  mt-3 ml-3 mr-3">
                <a href="#" class="btn btn-success mb-4" id="create-new-student">Add Student</a>
                <table class="table table-bordered" id="laravel_crud">
                    ...
                    <tbody id="students-crud">
                        @foreach ($students as $u_info)
                            <tr id="student_id_{{ $u_info->id }}">
                                <td>{{ $u_info->id }}</td>
                                <td>{{ $u_info->name }} {{ $u_info->surname }}</td>
                                <td>{{ $u_info->email }}</td>
                                <td>{{ $u_info->phone_number }}</td>
                                <td><a href="#" id="edit-student" data-id="{{ $u_info->id }}"
                                ...
                                <td>
                                    <a href="#" id="delete-student" data-id="{{ $u_info->id }}"
                                        class="btn btn-danger delete-student">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <div class="modal-body">
                    <form id="studentForm" name="studentForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="student_surname" name="surname"
